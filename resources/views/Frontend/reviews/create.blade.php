    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <h1 class="display-6 fw-bold mb-1">Leave a Review</h1>
                ...
                <form action="{{ route('frontend.reviews.store') }}" method="POST">
                    ...
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-1">
                                ...
                                Rate your Barber — {{ $booking->barber?->name ?? 'Barber' }}
                            </h6>
                    ...
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-1">
                                ...
                                Rate the Shop — {{ $booking->barberShop?->name ?? 'Shop' }}
                            </h6>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-trim text-white px-4">
