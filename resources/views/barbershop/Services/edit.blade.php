{{-- resources/views/barbershop/services/edit.blade.php --}}
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            ...
            <p class="text-muted mb-0">Update the details for this service</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <form action="{{ route('shop.services.update', $service->id) }}" method="POST">
                @csrf
                @method('PUT')
